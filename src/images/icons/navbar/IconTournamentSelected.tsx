...
function SvgIconTournamentSelected(props: SvgProps) {
    return (
        <Svg
            width={45}
            height={45}
        ...
        >
            <G clipPath="url(#clip0_127_381)">
                ...
                />
                <Path
                    d="M24.15 10.85l.901.3c.94.314 1.411.47 1.68.844.27.373.27.869.269 1.86v.07c0 .817 0 1.226-.197 1.56-.197.335-.554.533-1.269.93l-2.809 1.561M10.85 10.85l-.901.3c-.94.314-1.411.47-1.68.844C8 12.367 8 12.863 8 13.854v.07c0 .817 0 1.226.197 1.56.197.335.554.533 1.269.93l2.809 1.561"
                    stroke="#D2D2D2"
                    strokeWidth={2}
                />
                <Path
...
export default SvgIconTournamentSelected
